...
from IDEC_DEC import cluster_acc, ClusteringLayer, autoencoder
...
if __name__ == "__main__":
    ...
    parser.add_argument('dataset', default='mnist', choices=['mnist', 'usps', 'reutersidf10k', 'aol'])
    ...
    from datasets import load_mnist, load_reuters, load_usps, load_aol
    ...
    elif args.dataset == 'aol':
        x, y = load_aol('data/aol') # use mnist parameters and weights
